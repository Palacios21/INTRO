...
st.header("En este espacio comienzo a desarrollar mis aplicaciones para interfaces multimodales y jugar con ellas.")
st.write("Facilmente puedo realizar backend y frontend.")
image = Image.open('moda-futurista.png')
...
if st.button('Presiona el botón'):
    st.write('Esta es una forma de interactuar sobre una interfaz, dando a entender al usario que puede experimentar diferentes ámbitos')
else:
